...
function calcularImporte(cantidad, precioUnitario) {
...
describe('EP-11B Sprint 4 — Valoracion Economica Baremo', () => {
    ...
    function findVigentBaremo(companiaId) {
