 ...
 */
export async function enqueuePartePdf(supabase, params) {
 ...
 */
export async function processDocumentStub(supabase, documentoId) {
    // Mark as processing
    await supabase
        .from('documentos')
...
export async function getPendingDocuments(supabase) {
