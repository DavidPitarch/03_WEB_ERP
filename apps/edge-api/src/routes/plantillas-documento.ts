...
plantillasDocumentoRoutes.post('/', async (c) => {
  ...
  await insertAudit(supabase, { tabla: 'plantillas_documento', operacion: 'INSERT', registro_id: data.id, actor_id: user.id, datos_nuevos: data });
...
plantillasDocumentoRoutes.put('/:id', async (c) => {
  ...
  await insertAudit(supabase, { tabla: 'plantillas_documento', operacion: 'UPDATE', registro_id: id, actor_id: user.id, datos_nuevos: patch });
  return c.json({ data, error: null });
});
...
plantillasDocumentoRoutes.delete('/:id', async (c) => {
  ...
  await insertAudit(supabase, { tabla: 'plantillas_documento', operacion: 'DELETE', registro_id: id, actor_id: user.id });
